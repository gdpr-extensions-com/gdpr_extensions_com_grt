...
CREATE TABLE tt_content (
	gdpr_color_of_border_teaser varchar(255) NOT NULL DEFAULT '',
	gdpr_color_of_text_teaser varchar(255) NOT NULL DEFAULT '',
	gdpr_same_as_url_teaser varchar(255) NOT NULL DEFAULT '',
	gdpr_alt_text_teaser varchar(255) NOT NULL DEFAULT '',
	gdpr_button_text_color_teaser varchar(255) NOT NULL DEFAULT '',
	gdpr_background_color_teaser varchar(255) NOT NULL DEFAULT '',
	gdpr_business_locations_teaser varchar(255) NOT NULL DEFAULT '',
	gdpr_business_locations_teaser_rev varchar(255) NOT NULL DEFAULT '',
);
