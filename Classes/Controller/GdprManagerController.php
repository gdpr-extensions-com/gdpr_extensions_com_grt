...
use GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\MapLocation;
...
class GdprManagerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    public function listAction(): \Psr\Http\Message\ResponseInterface
    {
        ...
        $reviewListData = $this->gdprManagerRepository->findByExtension_key('gdpr_extensions_com_grt')->toArray();
     ...
     * action show
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\GdprManager $gdprManager
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function showAction(\GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * action create
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\GdprManager $newGdprManager
     */
    public function createAction(\GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\GdprManager $newGdprManager)
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function editAction(\GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
        ...
        if(strpos($gdprManager->getExtensionKey(), 'gdpr_extensions_com_grt') !== false){
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function updateAction(\GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\GdprManager $gdprManager) : \Psr\Http\Message\ResponseInterface
    {
        if($this->request->hasArgument('tx_GdprExtensionsComGrt_web_GdprExtensionsComGrtgdprmanager')){
            $locationsData = $this->request->getArgument('tx_GdprExtensionsComGrt_web_GdprExtensionsComGrtgdprmanager')['locations'];
        }
     ...
     * @param \GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\GdprManager $gdprManager
     */
    public function deleteAction(\GdprExtensionsCom\GdprExtensionsComGrt\Domain\Model\GdprManager $gdprManager)
    {
